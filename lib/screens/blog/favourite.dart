...
class FavouriteMarker extends StatefulWidget {
  @override
  _FavouriteMarkerState createState() => _FavouriteMarkerState();
}

class _FavouriteMarkerState extends State<FavouriteMarker> {
  @override
